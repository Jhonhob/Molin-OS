...
> **TL;DR** 墨麟OS 运行于 macOS 15+ / Python 3.11+ / Node.js 24+ 环境，通过 Molin-OS 仓库一键部署，核心依赖 DeepSeek API + Supermemory 记忆服务，5 个 Agent 通过 Hermes profiles 独立运行，共享 CloakServe CDP 浏览器池。
...
- **2026-05-19**: 从部署文档、部署流程、工具链规范、部署方案决策四份文档合并到部署环境目录，作为系统层环境配置的唯一标准
