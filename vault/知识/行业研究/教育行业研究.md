...
> **TL;DR**：教育行业研究合集（GitHub 教育项目 + K-12 竞品 + 火花思维投放素材 + 知识图谱索引）。六大趋势：多 Agent 教育从概念走向工程、费曼学习法 AI 化落地、BKT+SM-2 混合架构成标配、Copilot SDK 教育集成、知识图谱半自动化构建、间隔重复生态向 MCP 演进。产出 10 个可复用设计模式（三 Agent 教学分工/Mesh 事件驱动/Growth Mindset 评估等）+ 3 组火花思维投放素材包（3 节无忧退/资金监管/6 对 1 服务）+ 三阶段投放策略。竞品覆盖学而思素养。知识图谱索引含 63 文件、33 条关联关系。
...
### 结论
学而思(好未来)、猿辅导、作业帮三家公司初始画像建立完成。学而思素养定位尖子生培优，奥数体系延伸；行业整体向AI辅助教学+个性化学习方向演进。

### 背景
对北京教育科技三巨头进行第一次深度调研，建立竞品档案。
...
- **2026-05-19**: 5个教育研究文件合并为单一长青文档（GitHub教育项目研究 + K-12竞品 + 火花投放素材 + 知识图谱索引），原因：这些文件互有交叉引用（如 GitHub 教育项目包含学而思分析，学而思分析引用火花投放），分散存储导致信息孤岛，合并后形成完整教育行业知识资产。
- **2026-05-17**: 新增GitHub教育项目深度研究（6大趋势 + 10个设计模式 + 6个深度阅读项目），原因：feifei-companion等中文教育AI项目兴起，多Agent教育从概念走向工程，需系统吸收开源生态的最新方法论。
- **2026-05-17**: 新增K-12学而思素养竞品分析，原因：火花思维投放需要参考同行卖点和定位，学而思作为奥数体系延伸是直接参考。
- **2026-05-17**: 新增火花思维三组投放素材（3节无忧退/资金监管/6对1服务），原因：广告投放团队需要可直接交付的素材包，基于三大信任壁垒（退费保障/资金安全/服务密度）设计。
- **2026-05-17**: 清理CareerOps/Boss直聘误混入的垃圾数据（206-218行），原因：旧合并脚本在vault重组时把非教育领域对话碎片混入，破坏文档纯粹性。
- **2026-05-16**: 北京教育科技三巨头初始画像建立（学而思/猿辅导/作业帮），原因：教育Agent业务方向研判需要竞品对标，三巨头覆盖了K-12的主流教学模式。
