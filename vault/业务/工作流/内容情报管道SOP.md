...
> **TL;DR** 内容情报管道是墨麟全媒体内容飞轮的第一棒（08:00）——从 12+ 数据源并行拉取热词、归一化评分、竞品对标、到选题推荐的结构化输出，在内容创作之前先知道「什么在赢」。
...
- **2026-05-19**: 从流程/系统｜内容情报管道.md 迁移 — 统一到业务/工作流目录结构，对齐 Agent 中继 SOP 的反馈闭环体系
