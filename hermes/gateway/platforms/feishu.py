...
class FeishuAdapter(BasePlatformAdapter):
    ...
    def _build_resolved_approval_card(*, choice: str, user_name: str) -> Dict[str, Any]:
        """Build raw card JSON for a resolved approval action (v2 format)."""
        ...
        return {
            ...
            "header": {
                "title": {"tag": "plain_text", "content": f"{icon} {label}"},
    ...
    def _build_resolved_update_prompt_card(*, answer: str, user_name: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "config": {"update_multi": True},
            "header": {
                "title": {"tag": "plain_text", "content": f"{'✅' if yes else '❌'} Update prompt answered: {label}"},
    ...
    def format_message(self, content: str) -> str:
        """Strip Markdown so Feishu always receives clean plain text."""
        return _strip_markdown_to_plain_text(content.strip())
